...
def plot_update_rules(
  ...
  for latent_i in latent_order:
    ...
    if latent_sigmas[latent_i] < 0.5:
      ...
      # Choose which other latents to condition on, based on open input bottlenecks
      ...
      influential_latent_input_original_indices = update_net_inputs[is_latent_input_mask]
      update_net_input_latents = influential_latent_input_original_indices - start_idx_of_latents
